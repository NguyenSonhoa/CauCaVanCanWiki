...
skill-stamina:
  enabled: true
  default-maximum: 100
  full-recovery-seconds: 86400  # 0 -> 100% trong 24 giờ
  regeneration-per-tick: 1      # chỉ dùng khi full-recovery-seconds: 0
...
# Stamina này là tài nguyên skill CCVC, không phải MMOCore stamina.
`,
  fishHealth: `
# config.yml
fish-health:
